...
BLOG_AUTHOR = "Stephan Fitzpatrick"  # (translatable)
BLOG_TITLE = "PyHawaii"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://knowsuchagency.github.io/pyhi/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pyhi.io/"
BLOG_EMAIL = "knowsuchagency@gmail.com"
BLOG_DESCRIPTION = "For technical talks and all things PyHawaii :)"  # (translatable)
